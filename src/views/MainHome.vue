    ...
    export default {
        ...
        methods: {
                ...
                fetch(uri)
                    ...
                    .then(resultado => {
                        for (let i = 1; i <= resultado.total_pages; i++) {
                            let uri = "https://api.themoviedb.org/3/search/movie?api_key=" + apikey + "&query=" + movie + "&page=" + i + "&language=pt-BR";
            ...
            fetchMoviesByGenre(genre) {
                ...
                let uri = "https://api.themoviedb.org/3/discover/movie?api_key=" + apikey + "&with_genres=" + result.id + "&language=pt-BR";
